...
let selectCategory_Btn = document.getElementById("selectCategory")
let Show_category = document.getElementsByClassName("select_bx");
...
selectCategory_Btn.addEventListener("click",()=>{
    Show_category[0].classList.toggle("select_bx_active")
});
